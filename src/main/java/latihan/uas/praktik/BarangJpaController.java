...
import latihan.uas.praktik.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("latihan.uas_praktik_jar_0.0.1-SNAPSHOTPU");
